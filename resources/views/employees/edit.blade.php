        ...
        <div class="card-body">
          ...
          <form action="{{ route('employees.update', $employee->id) }}" method="POST">
            ...
            <p class="text-muted mb-3">
              Select deductions for this employee and configure how they will be deducted. SSS is automatically computed from gross pay during payroll generation.
            </p>
              ...
              <table class="table table-bordered">
                ...
                @forelse($deductionTypes as $dt)
                  @php
                    ...
                    $isRecurringGov = in_array($code, ['SSS', 'PHIC', 'PAGIBIG']);
                  @endphp
                    ...
                    <td>
                      @if($isAutoSSS)
                        ...
                        <div class="mb-2">
                          ...
                          <div class="form-control bg-light">Automatic</div>
                        </div>
                      ...
                      @if($isRecurringGov)
                        <small class="text-muted d-block mt-2">
                          ...
                          @elseif(in_array($code, ['PHIC', 'PAGIBIG']))
